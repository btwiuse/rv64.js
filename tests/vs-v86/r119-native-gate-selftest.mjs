...
const gate = join(here, "r119-native-gate.mjs");
const temp = await mkdtemp(join(tmpdir(), "r119-native-gate-"));
const controlWasm = "d9f686a9ce4f54734f310cf5789f900af0c9b7067539e0251c429f376dd3df6d";
const candidateWasm = "41b94faa9020b3c900919505a754c8ffe362d79fe5b68e68dce796e17f85def5";
...
try {
  ...
  assert.equal((await evaluate("protected-regression", makeNative({ pythonCandidate: 1015 })))
    .admitProductGates, false);
  console.log("R119 native gate selftest: verified target and protected-row decisions");
} finally {
