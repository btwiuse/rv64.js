...
// Apply the frozen R104/R107 verified-one-percent rule to R118. Boot is the
...
if (!nativeArg || !constructionArg || !outputArg) {
  throw new Error("usage: r118-native-gate.mjs NATIVE.json CONSTRUCTION.json OUTPUT.json");
}
...
const expected = {
  ...
  candidateWasmSha256: "0501207f314fd134ba981d41016d3c16ae8de70ce4278aca24b8fb22e5d6bd92",
...
const report = {
  schema: 1,
  experiment: "R118 flat RV64C current-baseline native gate",
