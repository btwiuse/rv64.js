...
// Apply the frozen R104/R107 verified-one-percent rule to R124. Compile is the
...
if (!nativeArg || !constructionArg || !outputArg) {
  throw new Error("usage: r124-native-gate.mjs NATIVE.json CONSTRUCTION.json OUTPUT.json");
}
...
const expected = {
  ...
  candidateWasmSha256: "d017a10f00a8813df7c1af5750c8d4cb3a74b0dccea548eea31850a4ac56da59",
...
const report = {
  schema: 1,
  experiment: "R124 RV64C-bank hybrid structured-state one-percent native gate",
