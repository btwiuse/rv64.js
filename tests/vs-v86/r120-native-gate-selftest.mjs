...
const gate = join(here, "r120-native-gate.mjs");
const temp = await mkdtemp(join(tmpdir(), "r120-native-gate-"));
const controlWasm = "d9f686a9ce4f54734f310cf5789f900af0c9b7067539e0251c429f376dd3df6d";
const candidateWasm = "c36da489ebe3e2f15d960a1ad393b808e9ff285dc099d4988c745e0e81065b32";
...
try {
  ...
  assert.equal((await evaluate("protected-regression", makeNative({ pythonCandidate: 1015 })))
    .admitProductGates, false);
  console.log("R120 native gate selftest: verified Compile target and protected-row decisions");
} finally {
