...
import { r093AssetManifest } from "./r093-browser-host.mjs";
...
const worker = readFileSync(
  join(root, "tests/jit-modern-boot-r093-browser-worker.mjs"),
  "utf8",
);
const sourceOrder = [
...
const manifest = r093AssetManifest();
assert.equal(
...
console.log(
  "R093 browser harness selftest: separate artifact identities, production policy, " +
