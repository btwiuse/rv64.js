...
import { r085AssetManifest } from "./r085-browser-host.mjs";
...
const worker = readFileSync(
  join(root, "tests/jit-modern-boot-r085-browser-worker.mjs"),
  "utf8",
);
const sourceOrder = [
...
const manifest = r085AssetManifest();
assert.equal(
...
console.log(
  "R085 browser harness selftest: separate artifact identities, production policy, " +
