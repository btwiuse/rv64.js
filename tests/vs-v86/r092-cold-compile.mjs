...
// Seven alternating fresh-process cold compile/instantiate pairs for R092.
...
if (!controlPath || !candidatePath || !outputPath) {
  throw new Error("usage: r092-cold-compile.mjs CONTROL.wasm CANDIDATE.wasm OUTPUT.json");
}
