...
import { evaluateR100, R100_REQUIREMENTS as req } from "./r100-native-gate-lib.mjs";
...
const pass = evaluateR100(report);
...
assert.equal(evaluateR100(weakCompile).admitProductGates, false);
...
assert.equal(evaluateR100(fakeSpeedup).checks.compileNormalizedMips, false);

console.log("R100 native gate selftest: PASS");
