...
// Apply the frozen R104/R107 verified-one-percent rule to R119. Boot is the
// target; Compile and Python are protected. This file is frozen before the
...
if (!nativeArg || !constructionArg || !outputArg) {
  throw new Error("usage: r119-native-gate.mjs NATIVE.json CONSTRUCTION.json OUTPUT.json");
}
...
const expected = {
  ...
  candidateWasmSha256: "41b94faa9020b3c900919505a754c8ffe362d79fe5b68e68dce796e17f85def5",
...
const report = {
  schema: 1,
  experiment: "R119 existing-probe fused execute-TLB native gate",
